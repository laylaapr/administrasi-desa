...
<head>
    ...
    <title>LAYANAN ADMINISTRASI DESA<?php echo get_setting('komplek');?></title>
    <!-- Favicon-->
...
<body class="login-page">
    <div class="login-box">
        <div class="logo" style="width: 100%; color: white;"><center>
            <h3>Layanan Administrasi Desa Gulbung</h3>
            <h5></h5>
            </center>
        </div>
        <div class="card">
            <div class="body">
                ...
                <form id="sign_in" action="<?php echo site_url('Auth/doLogin');?>" method="POST">
                    <div class="msg">Gunakan Username dan Password anda untuk Login</div>
