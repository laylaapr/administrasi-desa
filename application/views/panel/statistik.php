...
<script type="text/javascript">
	...
	var agama = new Chart(agamaC,{
		...
		data: {
			...
			datasets:[{
				label:'Jumlah Warga',
				data:[<?php foreach($ag as $c){echo jml_warga_by_agama($id,$c->agama).',';};?>],
				backgroundColor:[
	...
	var pekerjaan = new Chart(pekerjaanC,{
		...
		data: {
			...
			datasets:[{
				label:'Jumlah Warga',
				data:[<?php foreach($pk as $c){echo jml_warga_by_pekerjaan($id,$c->pekerjaan).',';};?>],
				backgroundColor:[
	...
	var pendidikan = new Chart(pendidikanC,{
		...
		data: {
			...
			datasets:[{
				label:'Jumlah Warga',
				data:[<?php foreach($pn as $c){echo jml_warga_by_pen($id,$c->pendidikan).',';};?>],
				backgroundColor:[
